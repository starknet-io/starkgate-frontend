...
describe('parseFromUint256', () => {
  it('should parse from uint256', () => {
    expect(parseFromUint256({high: '0x0', low: '0x56bc75e2d63100000'})).toEqual('100');
    expect(parseFromUint256({high: '0x0', low: '0x21e19e0c9bab2400000'})).toEqual('10000');
    expect(parseFromUint256({high: '0x0', low: '0x84595161401484a000000'})).toEqual('10000000');
  });
});
