...
const envs = {
  ...
  localStorageOnboardingTimestampKey: process.env.REACT_APP_LOCAL_STORAGE_ONBOARDING_TIMESTAMP_KEY,
  onboardingModalTimeoutHr: process.env.REACT_APP_ONBOARDING_MODAL_TIMEOUT_HR
};
